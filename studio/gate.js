...
try {
  ...
  const shellResponse = fetch('./app-shell.html?v=exam-20260916').then(async response => {
  ...
  const app=await import('./src/app.js?v=history-20260916');appModule=app;shutdown=app.shutdownStudio;
