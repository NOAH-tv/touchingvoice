...
try {
  ...
  const shellResponse = fetch('./app-shell.html?v=female-tracks-20260913').then(async response => {
  ...
  const app=await import('./src/app.js?v=monitor-background-20260913');appModule=app;shutdown=app.shutdownStudio;
